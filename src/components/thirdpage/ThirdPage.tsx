          ...
          <div className="flex flex-col gap-2">
            ...
            >
              {frontend.map((item, idx) => (
                ...
                >
                  <Tooltip>
                    <TooltipTrigger className="flex flex-col items-center justify-center p-5 text-center bg-slate-800/50 backdrop-blur-md rounded-2xl border border-sky-300/20 transition-all duration-300 ease-in-outhover:bg-slate-800/70 hover:border-sky-300/40 hover:-translate-y-1">
                      {item.logo}
                    </TooltipTrigger>
